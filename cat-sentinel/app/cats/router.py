...
@router.get("/", response_model=list[CatRead], summary="List cats")
...
@router.get("/{cat_id}", response_model=CatRead, summary="Get a cat")
...
@router.patch("/{cat_id}", response_model=CatRead, summary="Update a cat's label or active status")
